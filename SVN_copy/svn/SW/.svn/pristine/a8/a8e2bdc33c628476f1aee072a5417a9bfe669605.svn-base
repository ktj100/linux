...
#
# Purpose:
#     This program will test the fdl for REGISTER DATA ACK ATTEMPT errors.
# Twenty six invalid attempts will be made, testing different parameters, and finally
...
def run():
    ...
    while fdlTestResult != False:   
        ...
        if KeepMoving != False:
            ...
            print(cntPassFail, "/18 tests passed")
            fdl_utils.stop_fdl()
            return True
