...
def sysInit(UDPsock, sysInit_passfail):
    ...
    UDPsock.sendto(struct.pack(SYS_INIT_MSG_FMT, *sendSysInitMsg ), (UDP_IP, UDP_PORT_DEST))
...
def sendPublish(UDPsock):
    ...
    UDPsock.sendto(struct.pack(SEND_PUBLISH_HDR_STR_FMT, *sendPublishData ), (UDP_IP, UDP_PORT_DEST) )
