...
#
# Purpose:
#     This program will test the simm for subscribe errors.
# Seventy six invalid attempts will be made, testing different parameters, and finally
...
def run():
    ...
    while SimmTestResult != False:
        ...
        if KeepMoving != False:
            ...
            print(cntPassFail, "/77 tests passed")
