...
void restart_process(int32_t s_pid, child_pid_list **first_node_ptr, child_pid_list **nth_node_ptr)
{
    ...
    // Set alive value to '0' to indicate that the old process will no longer be dealt with
    nth_node->alive = 0;    
    ...
    // copy the name and directory path for the module that needs restarting to be placed into the new link
